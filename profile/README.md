...
🎟️ **Alfa is open, seats limited** → [playcatchfleet.com](https://playcatchfleet.com)
...
| Repo | What it is |
| --- | --- |
| [catchfleet](https://github.com/catchfleet/catchfleet) | The open side of the game: design docs, catalog review decisions, type content, roadmap, and the public issue tracker |
| [listener](https://github.com/catchfleet/listener) | The small bridge between your local ADS-B decoder (SBS1) and your Dex; Alfa release builds |
...
decision for every aircraft. The game design and every product decision are
human. Judge for yourself.
